...
step_of_model = 10
path = 'assets/datasets/FashionMNIST_mlp_models/' + str(step_of_model) + '.pt'
model.load_state_dict(torch.load(path))

noise = 0
if not os.path.exists("assets/datasets/params_with_noise/FashionMNIST_mlp_step_" + str(step_of_model) + "/"):
    os.makedirs("assets/datasets/params_with_noise/FashionMNIST_mlp_step_" + str(step_of_model) + "/")
outputfile = "assets/datasets/params_with_noise/FashionMNIST_mlp_step_" + str(step_of_model) + "/"
