...
step_of_model = 35
path = 'assets/datasets/FashionMNIST_cnn_models/' + str(step_of_model) + '.pt'
model.load_state_dict(torch.load(path))

noise = 0
if not os.path.exists("assets/datasets/params_with_noise/FashionMNIST_cnn_step_" + str(step_of_model) + "/"):
    os.makedirs("assets/datasets/params_with_noise/FashionMNIST_cnn_step_" + str(step_of_model) + "/")
outputfile = "assets/datasets/params_with_noise/FashionMNIST_cnn_step_" + str(step_of_model) + "/"
