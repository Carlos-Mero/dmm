...
class trainer():
    def __init__(self):
        ...
        if not os.path.exists("../datasets/MNIST_mlp_models/"):
            os.makedirs("../datasets/MNIST_mlp_models/")
    ...
    def train(self):
        ...
        torch.save(self.model.state_dict(), f"../datasets/MNIST_mlp_models/{self.model_count}.pt")
        print(f"Finished training mlp on MNIST [{self.model_count}/1024]")
        self.model_count += 1
    def test(self):
