...
class trainer():
    def __init__(self):
        ...
        if not os.path.exists("../datasets/FashionMNIST_cnn_models/"):
            os.makedirs("../datasets/FashionMNIST_cnn_models/")
    ...
    def train(self):
        ...
        torch.save(self.model.state_dict(), f"../datasets/FashionMNIST_cnn_models/{self.model_count}.pt")
        print(f"Finished training cnn on FashionMNIST [{self.model_count}/1024]")
        self.model_count += 1
    def test(self):
