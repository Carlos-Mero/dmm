...
class trainer():
    def __init__(self):
        ...
        if not os.path.exists("../datasets/FashionMNIST_models/"):
            os.makedirs("../datasets/FashionMNIST_models/")
    ...
    def train(self):
        ...
        torch.save(self.model.state_dict(), f"../datasets/FashionMNIST_models/{self.model_count}.pt")
